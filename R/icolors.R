...
#' @keywords utilities
icolors <-
  function(set=c('general', 'general2', 'bg', 'bgpng', 'cmyk', 'CC', 'CCalt', 'f2', 'sex', 'main', 'crayons', 'web', 'summer21', 'pantone', 'mario', 'gothic'))
  {
    ...
    # cmyk printing
    cmyk <- c('c'=rgb(0, 255, 255, maxColorValue=255),
...
icolors.plot <-
  function(set=c('general', 'general2', 'bg', 'bgpng', 'cmyk', 'CC', 'CCalt', 'f2', 'sex', 'main', 'crayons', 'web', 'summer21', 'pantone', 'mario', ''),
    ...
    if(method2order == 'hsv') {
      ...
      ord <- order(names(set)!='Black', names(set)!='Gray',
                   names(set)!='Silver', names(set)!='White',
    ...
    text(x+dx*1.2, y, names(set)[ord], cex=cex, adj=c(0, 0.5))
  }
...
icolors.lookup <-
  function(color_names=NULL, ...)
  {
    ...
    sets <- c('general', 'general2', 'bg', 'bgpng', 'cmyk', 'CC', 'CCalt', 'f2', 'sex', 'main', 'crayons', 'web', 'summer21', 'pantone', 'mario', 'gothic')
    
    if(is.null(color_names)) return(sets)
